<template>
  <div ref="dockedLayout" class="docked-layout">
    ...
    <section>
      ...
      <div class="summary">
        <div v-if="step === 1">
          <img src="/static/images/v3/Comprehension.svg">
          <h3 class="what-is-involved">What is involved</h3>
        ...
        <div v-if="step === 2">
          <img src="/static/images/v3/Privacy.svg">
          <h3 class="data-collection">Data Collection, Storage & Privacy</h3>
          <ul>
        ...
        <div v-if="step === 3">
          <img src="/static/images/v3/Data%20use%20and%20trends.svg">
          <h3 class="trends">Data Use & Trends</h3>
          <ul>
        ...
        <div v-if="step === 4">
          <img src="/static/images/v3/future%20research.svg">
          <h3 class="sharing">Sharing for Future Research</h3>
          <ul>
        ...
        <div v-if="step === 5">
          <img src="/static/images/v3/Risks.svg">
        ...
        <div v-if="step === 6">
          <img src="/static/images/v3/Benefits.svg">
        ...
        <div v-if="step === 7">
          <img src="/static/images/v3/Issues%20to%20consider.svg">
          <h3 class="issues">Issues to Consider</h3>
          <ul>
        ...
        <div v-if="step === 8">
          <img src="/static/images/v3/Not%20medical%20care.svg">
          <h3 class="not-medical">NOT medical care</h3>
          <ul>
        ...
        <div v-if="step === 9">
          <img src="/static/images/v3/Leave.svg">
          <h3 class="leaving">Leaving the Study</h3>
          <ul>
        ...
        <div v-if="step === 10">
          <img src="/static/images/v3/contact.svg">
...
img {
  ...
  .data-collection {
      background-image: url(/static/images/v3/Privacy.svg);
      background-size: 10%;
      background-position: center left;
  }
  .trends {
      background-image: url(/static/images/v3/Data%20use%20and%20trends.svg);
      background-size: 10%;
      background-position: center left;
  }
  .sharing {
      background-image: url(/static/images/v3/future%20research.svg);
      background-size: 13%;
      background-position: center left;
  }
  .risks {
      background-image: url(/static/images/v3/Risks.svg);
      background-size: 8%;
      background-position: center left;
  }
  .benefits {
      background-image: url(/static/images/v3/Benefits.svg);
      background-size: 8%;
      background-position: center left;
  }
  .issues {
      background-image: url(/static/images/v3/Issues%20to%20consider.svg);
      background-size: 13%;
      background-position: center left;
  }
  .not-medical {
      background-image: url(/static/images/v3/Not%20medical%20care.svg);
      background-size: 13%;
      background-position: center left;
  }
  .leaving {
      background-image: url(/static/images/v3/Leave.svg);
      background-size: 8%;
      background-position: center left;
  }
  .contact {
      background-image: url(/static/images/v3/contact.svg);
      background-size: 10%;
      background-position: center left;
  }
